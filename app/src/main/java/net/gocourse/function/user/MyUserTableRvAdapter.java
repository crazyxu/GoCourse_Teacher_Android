 ...
 * FIXME
 */
public class MyUserTableRvAdapter extends RecyclerView.Adapter<MyUserTableRvAdapter.ViewHolder>{
    private List<DataCourseTable> tableList;
    private ClickCallBack callBack;
    private Context context;
    public MyUserTableRvAdapter(List<DataCourseTable> tableList, Context context, ClickCallBack callBack){
    ...
    public ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View v = LayoutInflater.from(parent.getContext()).inflate(R.layout.rv_item_user_course,parent,false);
    ...
    public void onBindViewHolder(ViewHolder holder, int position) {
        ...
        holder.tvName.setText(courseTable.getCourse().getCourseName());
        holder.rvLocations.setAdapter(new MyUserLocationRvAdapter(courseTable.getLocations()));
    ...
    public static class ViewHolder extends RecyclerView.ViewHolder implements View.OnClickListener{
        ...
        public ViewHolder(View itemView) {
            super(itemView);
            tvName=(TextView)itemView.findViewById(R.id.course_name);
