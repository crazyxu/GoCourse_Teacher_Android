 ...
 * FIXME
 */
public class MyDetailLocationRvAdapter extends RecyclerView.Adapter<MyDetailLocationRvAdapter.ViewHolder>{
    private List<TbCourseLocation> locationList;
    public MyDetailLocationRvAdapter(List<TbCourseLocation> locationList){
